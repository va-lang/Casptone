...
INSERT INTO `complaints` (`id`, `message`, `address`, `date_created`, `status`,`dateincident`,`timeincident`,`statusincident`,`tracking`) VALUES

(1,'aghasdhg', 'ahsgdahsdg', '2020-10-30 14:11:24', 1, '04/05/2023','6:40 PM','Investigation Needed','626edyd');
...
CREATE TABLE IF NOT EXISTS `verification` (
  ...
  -- FOREIGN KEY (`statusincident`) REFERENCES `complaints`(`statusincident`),
  -- FOREIGN KEY (`tracking`) REFERENCES `complaints`(`tracking`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `verification` (`complaint_id`,`status`) 
VALUES (1, 0);
...
--
-- ALTER TABLE `complaints` ADD UNIQUE KEY (`statusincident`, `tracking`);
-- ALTER TABLE `complaints` 
--   -- ADD PRIMARY KEY (`id`);
--
--
