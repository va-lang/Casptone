  ...
  <header class="masthead">
      <div class="container-fluid h-100">
          <div class="row h-100 align-items-center justify-content-center text-center">
              ...
              <div class="row mb-2 text-left justify-content-center ">
                 <button class="btn btn-primary" type="button" id="report_crime">Track your case</button>
              </div>                      -->
              </div>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5 bg-dark">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2020 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.sourcecodester.com/" target="_blank"></a></div></div>
        </footer>
